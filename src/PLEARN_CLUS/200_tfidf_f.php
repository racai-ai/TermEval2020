...
@mkdir("my");
@mkdir("my/$CORPUSLANG/tfidff");

foreach(["equi","corp","wind","hf"] as $corpus){
@mkdir("my/$CORPUSLANG/tfidff/$corpus");
...
arsort($tfidf);
saveStat($tfidf,"my/$CORPUSLANG/${corpus}_1_tfidff.txt");
...
arsort($tfidf);
saveStat($tfidf,"my/$CORPUSLANG/${corpus}_2_tfidff.txt");
...
arsort($tfidf);
saveStat($tfidf,"my/$CORPUSLANG/${corpus}_3_tfidff.txt");
...
arsort($tfidf);
saveStat($tfidf,"my/$CORPUSLANG/${corpus}_4_tfidff.txt");

foreach($tfidf as $w=>$n){if($n<4)unset($tfidf[$w]);}
$all=array_merge($all,$tfidf);


saveList($all,"my/$CORPUSLANG/tfidff/${corpus}/annotations_terms.ann");
}
