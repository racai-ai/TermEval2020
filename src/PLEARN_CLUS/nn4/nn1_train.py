...
A5=Dense(300, activation='relu',name="A5")(A4)

B1=Input(shape=(11,8),name="POS")
B2=Bidirectional(LSTM(10,return_sequences=True),name="B2")(B1)
B3=Dropout(0.2,name="B3")(B2)
...
O1=Concatenate(name="Combine")([A5,B5])
O2=Dense(100, activation="relu",name="O2")(O1)
O3=Dense(100, activation="relu",name="O3")(O2)
out=Dense(2,activation="softmax",name="OUT")(O3)
